...
- **Category Theme**: [[Agent Evaluation & Benchmarking]]
- **Source**: ARXIV
- **Original URL**: [https://arxiv.org/abs/2608.06362v1](https://arxiv.org/abs/2608.06362v1)

## Curator Reasoning

Introduces AV-AIVAT, combining action-informed value assessment variance reduction with continuous Confidence Sequences to deliver 74x cheaper, statistically certified anytime-valid early stopping in LLM agent evaluations for imperfect-information games.
