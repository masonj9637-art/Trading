---
source: arxiv
category: database systems & neurosymbolic ai
...
- **Category Theme**: [[Database Systems & Neurosymbolic AI]]
- **Source**: ARXIV
- **Original URL**: [https://arxiv.org/abs/2608.06331v1](https://arxiv.org/abs/2608.06331v1)

## Curator Reasoning

Introduces TYTAN for automated construction of analytic semantic schemas from relational databases via neurosymbolic inference and targeted human feedback, achieving 100% coverage and execution correctness across real-world databases.
