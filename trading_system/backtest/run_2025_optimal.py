...
async def run_backtest():
    ...
    # Target 2025 specifically
    end_date = datetime(2025, 12, 31)
    
    print("Fetching 465 days of historical data from Alpaca ending on 2025-12-31...")
    market_data = await fetcher.fetch_historical_data(symbols, days=465, end_date=end_date)
    
    print("Fetching 465 days of macro data from Yahoo Finance ending on 2025-12-31...")
    ...
    if not history_df.empty:
        ...
        # Save HTML tearsheet
        qs.reports.html(returns, output='reports/2025_optimal_backtest.html')
        print("Report saved to reports/2025_optimal_backtest.html")
    else:
