...
print("Searching SEC EFTS for mining/exploration candidates...")
...
mining_sics = ['1000', '1040', '1044', '1090', '1021', '1031', '1400', '1221']

# Search by SIC
for s in mining_sics:
...
print(f"\nTotal candidate mining tickers found: {len(candidates)}")

# Filter by Market Cap ($50M - $500M)
valid_mining_companies = {}
...
print(f"\nTotal valid small-cap mining companies ($50M-$500M): {len(valid_mining_companies)}")

with open('scratch/valid_mining_companies.json', 'w') as f:
    json.dump(valid_mining_companies, f, indent=2)
