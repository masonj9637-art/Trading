...
with open('scratch/final_fintech_rows.json', 'r') as f:
    rows = json.load(f)

md_lines = []
md_lines.append("# SEC 8-K Filings Review: Small-Cap Specialty Finance & Fintech Companies\n")
md_lines.append("## Executive Summary\n")
md_lines.append(f"- **Screening Criteria**: Small-Cap ($50M – $500M market cap), SIC Codes 6199 / 6153 / 6141 / 6159 or keyword search ('lending', 'loan portfolio', 'fintech', 'credit facility')")
...
with open('scratch/fintech_8k_review.md', 'w') as f:
    f.write("\n".join(md_lines))

print("Wrote scratch/fintech_8k_review.md successfully.")
