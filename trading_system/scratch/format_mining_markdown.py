...
with open('scratch/final_mining_rows.json', 'r') as f:
    rows = json.load(f)

md_lines = []
md_lines.append("# SEC 8-K Filings Review: Small-Cap Mining & Exploration Companies\n")
md_lines.append("## Executive Summary\n")
md_lines.append(f"- **Screening Criteria**: Small-Cap ($50M – $500M market cap), SIC Codes 1000–1099 or keyword search ('drilling results', 'exploration', 'mineral resource', 'assay results')")
...
with open('scratch/mining_8k_review.md', 'w') as f:
    f.write("\n".join(md_lines))

print("Wrote scratch/mining_8k_review.md successfully.")
