...
with open('scratch/valid_mining_companies.json', 'r') as f:
    companies = json.load(f)

print(f"Loaded {len(companies)} valid mining companies.")

selected_tickers = list(companies.keys())
...
print(f"\nTotal mining filings fetched and parsed: {len(results)}")

with open('scratch/parsed_mining_8k_filings.json', 'w') as f:
