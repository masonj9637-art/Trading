...
## Corpus Check
- 206 files · ~625,775 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 839 nodes · 1251 edges · 136 communities (116 shown, 20 thin omitted)
...
Cohesion: 0.25
Nodes (5): bootstrap(), DeepOrthogonalizer, AlphaIsolator, RegimeDetector, EMASmoother
...
- **Why does `AlpacaDataFetcher` connect `BacktestEngine` to `SECForm4Parser`, `trading_system/main.py`, `.fetch_historical_data`, `TradingSystem`, `engine.py`, `.__init__`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `TradingSystem` connect `TradingSystem` to `trading_system/main.py`, `PortfolioRanker`, `EnsembleAgent`, `GovernanceEngine`, `BacktestEngine`, `engine.py`, `VolatilityGuard`, `.__init__`?**
